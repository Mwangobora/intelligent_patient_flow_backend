...
class PatientMobileNotificationSerializer(serializers.Serializer):
    id = serializers.UUIDField()
    patient = serializers.UUIDField()
    patient_number = serializers.CharField(required=False, allow_null=True)
    appointment = serializers.UUIDField(allow_null=True)
    queue_entry = serializers.UUIDField(allow_null=True)
    notification_type = serializers.CharField()
    channel = serializers.CharField()
    recipient_user = serializers.UUIDField(allow_null=True)
