...
@pytest.fixture
def organization():
    return Organization.objects.create(name="Pharmacy Org", code="PHARM_ORG")


@pytest.fixture
def facility_type():
    return FacilityType.objects.create(name="Pharmacy Hospital", code="PHARM_HOSP")
...
def department(facility):
    return Department.objects.create(facility=facility, name="Outpatient", code="PHARM_OPD")


@pytest.fixture
def specialty():
    return Specialty.objects.create(name="Pharmacy General Medicine", code="PHARM_GEN_MED")
...
def patient(organization, facility):
    return Patient.objects.create(
        ...
        patient_number="PHARM-PAT-001",
        first_name="Neema",
        last_name="Kassim",
        phone_number="+255755601333",
    )
...
def practitioner_assignment(organization, facility):
    practitioner_type = PractitionerType.objects.create(
        name="Pharmacy Doctor", code="PHARM_DOCTOR", requires_license=True
    )
    practitioner = Practitioner.objects.create(
        organization=organization,
        practitioner_type=practitioner_type,
        practitioner_number="PHARM-DOC-001",
        first_name="Asha",
        last_name="Mollel",
    )
...
def encounter(
    ...
    return Encounter.objects.create(
        ...
        encounter_number="PHARM-ENC-001",
